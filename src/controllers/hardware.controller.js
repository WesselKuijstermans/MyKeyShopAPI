...
async function purchase(req, res) {
    ...
    if(!req.body.user) {
        throw new errors.EntityNotFoundError('User is required to purchase a piece of hardware hardware')
    }
    ...
    if(!hardware) {
        throw new errors.EntityNotFoundError(`hardware with id '${req.params.id}' not found`)
    }
